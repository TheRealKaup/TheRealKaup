...
Watched. Tried playing the original game first but the quicksave feature didn't actually save at all, so I lost some hours of progress and couldn't bother repeating the beginning of the game. I agreed to a deal so I had to watch or play Steins;Gate, so I moved to the show and I highly recommend doing so, beacuse the show is hooking, and the game is not at all.

<details>
  <summary>
    Spoilers:
  </summary>
  Can't really find something unique in the show. It feels like most of the elements in Steins;Gate I've seen somewhere else already. Neither the plot nor the characters are super special, except (from the Wikipedia article on Rintaro Okabe):

  > University of Applied Sciences said that Okabe is a rare case of a visual novel protagonist; the protagonist actually has their own traits to isolate themselves from the other characters. Okabe Rintaro from Steins;Gate is handled as a chuunibyou-type character, a Japanese term referring to teenagers and young adults who have developed traits from overly dramatic fictional characters for the purpose of standing out and looking unique.

  Still I guess it's just really good.
</details>
...
Here are a couple of bullet points that I stand by. Some of them are obvious so I don't bother justifying those. Also note that these are not objective, some people can prefer overly complicated, philosophical endings that don't really add up. Checking all of these points is sufficient (though not necessary) for a media to be [excellent](#excellent) or maybe even [exceptional](#exceptional).

- **Simple endings**, that are conclusive, not confusing, not underwhelming, make sense, and can be summarized in 1 to 2 sentences. Doesn't matter if happy, tragic of bittersweet. If the ending is good _and_ simple, you hit the nail on the head. It means you found exactly the point of the story, and that you know what you are doing, contrary to throwing a bunch of plot points at the end, hoping that they make up something that looks alright. Play [Omori](#Omori) if you don't know what I mean. A simple ending that you beileve is good is like a spear, if handled well it is much more likely to hit the viewer right in the heart. A convoluted ending is more like a hammer that is too heavy to lift, and if you do swing it it can accidentally hit the viewer in the head and cause brain damage. How poetic.
- Stick to a limited amount of characters that are introduced early in the story. You need time to build up characters and make the viewer connect to them. For example, introducing a character in the last couple of episodes and expecting the viewer to be sad when they die, will make you disappointed, the viewer will not care. They are already (hopefully) attached to the characters that led the story from the beginning. You want few main characters, rather than many, beacuse too many means superficial characters, and all the important characters won't have enough screen time. Fewer characters can also mean simpler story.
- No fillers.
